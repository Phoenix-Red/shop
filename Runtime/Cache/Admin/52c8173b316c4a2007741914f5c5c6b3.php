...
<div class="tab-div">
    ...
    <!-- tab body -->
    <div id="tabbody-div">
      <form action="<?php echo U('Admin/Goods/goodsAdd');?>" method="post" name="theForm" enctype="multipart/form-data" >
        <!-- 最大文件限制 -->
        ...
        <table width="90%" id="mix-table" style="display:none" align="center">
          ...
          <tr>
            ...
            </select><input type="hidden" name="" value="size"></td>
          </tr>
          ...
          <tr>
            ...
            <td><select name="color">
              ...
              <option value="紅色">紅</option>
            </select><input type="hidden" name="" value="color"></td>
          </tr>
