...
<div class="main-div">
  ...
  <table width="100%" id="general-table">
      ...
      <tr>
        ...
        <td>
          <input type="checkbox" name="attr_value[]" value="14寸">14寸
          <input type="checkbox" name="attr_value[]" value="15寸">15寸
          <input type="checkbox" name="attr_value[]" value="16寸">16寸
          <input type="hidden" name="attr_name" value="屏幕尺寸" placeholder="">
          <input type="hidden" name="attr_key" value="size" placeholder="">
        </td>
      </tr>
       <tr>
        <td class="label">颜色:</td>
        <td>
           <input type="checkbox" name="attr_value1[]" value="黑色">黑色
          <input type="checkbox" name="attr_value1[]" value="白色">白色
          <input type="checkbox" name="attr_value1[]" value="红色">红色
          <input type="hidden" name="attr_name1" value="颜色" placeholder="">
          <input type="hidden" name="attr_key1" value="color" placeholder="">
        </td>
      </tr>
      </table>
