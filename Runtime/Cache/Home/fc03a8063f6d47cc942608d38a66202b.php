...
<div class="recommendContent entry-content" id="show_hot_area">
      <?php if(is_array($hot_goods)): foreach($hot_goods as $key=>$h): ?><div class="goodsbox1">
...
<div class="recommendContent entry-content" id="show_best_area">
      <?php if(is_array($best_goods)): foreach($best_goods as $key=>$best): ?><div class="goodsbox1">
				<div class="imgbox1"><a href="<?php echo U('Home/Goods/goods', array('goods_id'=>$best['goods_id']));?>"><img src="<?php echo ($best["thumb_img"]); ?>" alt="<?php echo ($best["goods_name"]); ?>"></a></div>
			 <a href="<?php echo U('Home/Goods/goods', array('goods_id'=>$best['goods_id']));?>" title="<?php echo ($best["goods_name"]); ?>"><?php echo ($best["goods_name"]); ?></a><br>
              <font class="goodspice market">￥<?php echo ($best["market_price"]); ?>元</font>
			 			 <b class="f1">￥<?php echo ($best["shop_price"]); ?>元</b><br>			 
			</div><?php endforeach; endif; ?>
</div>
</div>  
    <div class="">
...
<div class="recommendContent entry-content" id="show_new_area">
      <?php if(is_array($new_goods)): foreach($new_goods as $key=>$new): ?><div class="goodsbox1">
				<div class="imgbox1"><a href="<?php echo U('Home/Goods/goods', array('goods_id'=>$new['goods_id']));?>"><img src="<?php echo ($new["thumb_img"]); ?>" alt="<?php echo ($new["goods_name"]); ?>"></a></div>
			 <a href="<?php echo U('Home/Goods/goods', array('goods_id'=>$new['goods_id']));?>" title="<?php echo ($new["goods_name"]); ?>"><?php echo ($new["goods_name"]); ?></a><br>
              <font class="goodspice market">￥<?php echo ($new["market_price"]); ?>元</font>
			 			 <b class="f1">￥<?php echo ($new["shop_price"]); ?>元</b><br>			 
			</div><?php endforeach; endif; ?>  
