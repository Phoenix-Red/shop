    ...
    <div class="us_login" style="float:left;">
      <div class="mbox" style="width:485px; height:430px; ">
        ...
        <div class="contentNew">
          <div class="l_box">
            <p>已注册用户请从这里登录</p>
            <form action="<?php echo U('Home/User/login');?>" method="post" name="loginForm" id="loginForm">
              <label> <span>用户名</span>
              ...
              <label> <span>密码</span>
                ...
                <span>验证码</span>
                <input type="text" class="inputBg" name="yzm" size="15" ><img src="<?php echo U('Home/User/yzm');?>" onclick="this.src=this.src+'?'+Math.random();" alt="">
    ...
    <div class="us_login" style="float:left;">
      ...
      <div class="mbox" style="width:488px; height:370px; border:none;">
              ...
              <p>但注册之后您可以：</p>
					    ...
					    <p>3. 享受会员积分制度</p>
					    <p>4. 订阅本店商品信息</p>
					    <p><a href='<?php echo U('Home/User/reg');?>'><img src="/Public/Home/images/bnt_ur_regh.gif"></a></p>
				    </div>
				</div>
			</div>
      </div>
