...
<div class="main-div">
  ...
  <table width="100%" id="general-table">
      <tr>
        ...
        <td>
          <input type='text' name='cat_name' maxlength="20" value="<?php echo ($info['cat_name']); ?>" size='27' /> <font color="red">*</font>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>
          <textarea name='intro' rows="6" cols="48"><?php echo ($info['intro']); ?></textarea>
        </td>
      </tr>
      </table>
