    ...
    <div class="us_login" style="float:left;">
      <div class="mbox" style="width:485px; height:430px; ">
        ...
        <div class="contentNew">
          <div class="l_box">
            <p>已注册用户请从这里登录</p>
            <form action="<?php echo U('Home/User/checkyzm');?>" method="post" name="loginForm" id="loginForm">
              <label> <span>用户名</span>
              ...
              <label> <span>密码</span>
                ...
                <span>验证码</span>
                <input type="text" class="inputBg" name="yzm" size="15"><img src="<?php echo U('Home/User/yzm');?>" alt="">
